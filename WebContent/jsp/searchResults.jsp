...
// this was the traditional way of displaying the products using the servlet
// here we put placeholders and replace the placeholders with respective values
// by converting the html to string, Using MessageFormat and then printing back to screen.
//  Refer to /html/searchResults.html and /servlets/searchServlets.java for servlet version
